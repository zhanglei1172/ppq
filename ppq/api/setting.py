...
class TemplateSetting:
    ...
    def __init__(self) -> None:
        self.my_first_parameter = (
            "This Parameter just shows you how to create your own parameter."
        )
...
class DispatchingTable:
    def __init__(self) -> None:
        ...
        self.intro_1 = (
            "Any thing listed in this table will override the policy of PPQ dispatcher."
        )
        self.intro_2 = "Example above shows you how to edit a valid dispatching table."
        self.attention = (
            "All operation names that can not be found with your graph will be ignored."
        )
...
class QuantizationSettingFactory:
    ...
    def from_json(json_obj: Union[str, dict]) -> QuantizationSetting:
        ...
        if "version" not in setting_dict:
            ppq_warning(
                "Can not find a valid version from your json input, input might not be correctly parsed."
            )
        else:

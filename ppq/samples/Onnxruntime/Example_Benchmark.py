...
with API.ENABLE_CUDA_KERNEL():
    quantized = API.quantize_torch_model(
        ...
        platform=ppq.TargetPlatform.ONNXRUNTIME,
    )

API.export_ppq_graph(
    quantized, platform=ppq.TargetPlatform.ONNXRUNTIME, graph_save_to="Quantized.onnx"
)

API.export_ppq_graph(
    quantized, platform=ppq.TargetPlatform.ONNX, graph_save_to="FP32.onnx"
)

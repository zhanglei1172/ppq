...
def Benchmark(
    ...
    * Set providers=CUDAExecutionProvider before benchmark this file.
    ...
    sess = ort.InferenceSession(
        path_or_bytes=onnx_file, providers=providers, provider_options=provider_options
    )
...
def Profile(
    ...
    * Set providers=CUDAExecutionProvider before benchmark this file.
    ...
    print(
        f"Profile file is generated at {prof_file}, open it with your web browser chrome://tracing/"
    )

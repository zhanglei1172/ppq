...
parser.add_argument(
    "--input_dlc_model",
    default="snpe_quantized.dlc",
    help="path to snpe quantized dlc model",
)
parser.add_argument(
    "--output_dlc_model", default="ppq_export.dlc", help="path to export quantized dlc"
)
parser.add_argument(
    "--qparam", default="quantized.json", help="path to ppq qparams json"
)
